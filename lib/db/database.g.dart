    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Question` (`id` INTEGER, `category` TEXT NOT NULL, `type` TEXT NOT NULL, `difficulty` TEXT NOT NULL, `question` TEXT NOT NULL, `correctAnswer` TEXT NOT NULL, `answers` TEXT NOT NULL, PRIMARY KEY (`id`))');
